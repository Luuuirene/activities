...
import com.activities_photo.model.ItemVO_ForPh;
...
public class Photo_Compositegory {
	...
	public static Predicate getPhoto_For_AnyDB(CriteriaBuilder builder, Root<PhotoVO> root, String columnName, String value) {
		...
		if("activityPhotoId".equals(columnName)) {
			...
			ItemVO_ForPh itemVO_ForPh = new ItemVO_ForPh();
			itemVO_ForPh.setActivityId(Integer.valueOf(value));
			predicate = builder.equal(root.get("itemVO_ForPh"), itemVO_ForPh);
		}
		return predicate;
	}
