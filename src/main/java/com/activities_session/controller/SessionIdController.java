...
public class SessionIdController {
	...
	public String getOne_For_Display(
		...
		if(sessionVO == null) {
			...
			return "back-end/session/select_session";
		}
		...
		return "back-end/session/select_session"; // 查詢完成後轉交select_session.html由其第158行insert listOneEmp.html內的th:fragment="listOneEmp-div
	}
	...
	public ModelAndView handleError(HttpServletRequest req, ConstraintViolationException e , Model model) {
		...
		//==== 以下是當前面第59行返回 /src/main/resources/templates/back-end/session/select_session.html用的 ====   
	    ...
	    return new ModelAndView("back-end/session/select_session", "errorMessage", "請修正以下錯誤:<br>"+message);
	}
