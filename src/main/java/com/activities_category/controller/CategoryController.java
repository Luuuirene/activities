...
public class CategoryController {
	...
	public String addCategory(ModelMap model) {
		...
		return "back-end/category/addCategory";
	}
...
//	}
	...
	public String delete(@RequestParam("activityCategoryId") String activityCategoryId, ModelMap model) {
		...
		return "back-end/category/listAllCategory"; // 刪除完成後轉交listAllCategory.html
	}
	...
	public String getOne_For_Update(@RequestParam("activityCategoryId") String activityCategoryId, ModelMap model) {
		...
		return "back-end/category/update_category_input"; // 查詢完成後轉交update_category_input.html
	}
	...
	public String update(@Valid CategoryVO categoryVO, BindingResult result, ModelMap model) throws IOException{
		...
		if(result.hasErrors()) {
			...
			return "back-end/category/update_category_input";
		}
		/*************************** 2.開始修改資料 *****************************************/
		...
		model.addAttribute("categoryVO", categoryVO);
		return "back-end/category/listOneCategory"; // 修改成功後轉交listOneCategory.html
